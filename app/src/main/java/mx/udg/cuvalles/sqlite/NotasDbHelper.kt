...
class NotasDbHelper(context: Context?,
    ...
    fun addNota(titulo:String, contenido:String){
        //objeto tipo ContentValues para formar objetos tipo clave-valor
        val contetntValues = ContentValues()
        contetntValues.put(TITLE,titulo)
        contetntValues.put(CONTENT,contenido)
        database!!.insert(NOMBRE_TABLA, null, contetntValues)
    }
